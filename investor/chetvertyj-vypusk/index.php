		...
		<div class="block-h2">
			...
			<div class="row">
				<div class="col-12 col-md-6">
					...
					<p class="mt-4">Номинальная стоимость одной облигации равна 1000 рублей. Ставка 1-4 купонов, регулярных процентных выплат по облигациям, установлена на уровне 12% годовых. Периодичность выплаты купона – 4 раза в год (ежеквартально). К данному доходу применяется льгота по налогу на доходы физических лиц (НДФЛ), как и к доходам по банковским депозитам.</p>
