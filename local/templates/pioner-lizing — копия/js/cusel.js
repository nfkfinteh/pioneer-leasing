...
function cuselExpand(sh)
{
	if (sh === true)
	{
		$('#cusel-scroll-select-leasing-type span[val="-1"]').hide();
		$('#cusel-scroll-sale-category-select span:first[val=""]').hide()
	} else {
		//$('#cusel-scroll-select-leasing-type span[val="-1"]').show();
	};
}
