	...
	<div class="row">
		<div class="col-12 col-md-6 col-xl-8 offset-md-6 offset-xl-4">
			<div class="question-block__title">
				<?$APPLICATION->IncludeComponent("bitrix:main.include", "", array(
                    "AREA_FILE_SHOW" => "file",
                    "PATH" => SITE_TEMPLATE_PATH."/include_areas/forms/question_title.php",
                ));?>
			</div>
			<p class="question-block__description">
				<?$APPLICATION->IncludeComponent("bitrix:main.include", "", array(
                    "AREA_FILE_SHOW" => "file",
                    "PATH" => SITE_TEMPLATE_PATH."/include_areas/forms/question_subtitle.php",
                ));?>
			</p>
		</div>
		<div class="col-12 col-md-6 col-xl-4 offset-md-6 offset-xl-4 offset-xxl-4 col-xxl-3">
			<div class="input input_w-175">
					...
					<label class="input__label" for="fio"><?=GetMessage("MFT_NAME")?><?if(empty($arParams["REQUIRED_FIELDS"]) || in_array("NAME", $arParams["REQUIRED_FIELDS"])):?> <span class="mf-req">*</span><?endif?></label>
			</div>
		</div>
		<div class="col-12 col-md-6 col-xl-4 col-xxl-2 col-xxxl-3 offset-md-6 offset-xl-0 mt-3 mt-xl-0">
			<div class="input">
					...
					<label class="input__label" for="phone"><?=GetMessage("MFT_PHONE")?><?if(empty($arParams["REQUIRED_FIELDS"]) || in_array("PHONE", $arParams["REQUIRED_FIELDS"])):?> <span class="mf-req">*</span><?endif?></label>
			</div>
		</div>
