	...
	<div class="row">
		...
		<div class="col-12 col-md-6 col-xl-4 offset-md-6 offset-xl-4 offset-xxl-4 col-xxl-3">
			<div class="input input_w-175">
					<input class="input__input" name="user_name" id="fio2" type="text">
					<label class="input__label" for="fio2"><?=GetMessage("MFT_NAME")?><?if(empty($arParams["REQUIRED_FIELDS"]) || in_array("NAME", $arParams["REQUIRED_FIELDS"])):?> <span class="mf-req">*</span><?endif?></label>
			</div>
		</div>
		<div class="col-12 col-md-6 col-xl-4 col-xxl-2 col-xxxl-3 offset-md-6 offset-xl-0 mt-3 mt-xl-0">
			<div class="input">
					<input class="input__input" name="user_phone" id="phone2" type="text">
					<label class="input__label" for="phone2"><?=GetMessage("MFT_PHONE")?><?if(empty($arParams["REQUIRED_FIELDS"]) || in_array("PHONE", $arParams["REQUIRED_FIELDS"])):?> <span class="mf-req">*</span><?endif?></label>
			</div>
		</div>
