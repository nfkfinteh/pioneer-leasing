...
$coord_Point = $arr_Point->arrPoints;
//print_r($coord_Point);
$id_points = scandir($_SERVER["DOCUMENT_ROOT"].'/local/scripts/map/points');
...
foreach ($id_points  as $id) {
    $content = file($_SERVER["DOCUMENT_ROOT"].'/local/scripts/map/points/'.$id.'/admindata.txt');
...
$arr_img_scheet = array(
    array(
        $server_url.'img/nrm_blbord_red.png',
        $server_url.'img/nrm_blbord_red_green.png',
        $server_url.'img/nrm_blbord_red_yellow.png'
    ),
    array(
        $server_url.'img/nrm_blbord_red_green.png',
        $server_url.'img/nrm_blbord_green.png',
        $server_url.'img/nrm_blbord_green_yellow.png'
    ),
    array(
        $server_url.'img/nrm_blbord_yellow_red.png',
        $server_url.'img/nrm_blbord_yellow_green.png',
        $server_url.'img/nrm_blbord_yellow.png'
    )
    );
$arr_st_a = array(
